...
const STRK_TOKEN_ADDRESS =
  process.env.NEXT_PUBLIC_STRK_TOKEN || '0x04718f5a0fc34cc1af16a1cdee98ffb20c31f5cd61d6ab07201858f4287c938d'

// Direct RPC provider for read-only calls (bypasses wallet)
const RPC_URL =
  process.env.NEXT_PUBLIC_STARKNET_RPC || 'https://starknet-sepolia.public.blastapi.io/rpc/v0_8'
 ...
 * FileVault v2 signature: create_vault(cid, price:u256, integrity_hash:felt, commitment:felt, ttl:u64)
 ...
 */
export async function createVault(account, { cid, price, integrityHash, integrity_hash, commitment, keySeedCiphertext, ttl, fee }) {
  if (!VAULT_ADDRESS) throw new Error('NEXT_PUBLIC_FILEVAULT_ADDRESS not set')
